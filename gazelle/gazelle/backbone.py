...
class DinoV2BackboneTimm(Backbone):
    def __init__(self, model_name):
        super(DinoV2BackboneTimm, self).__init__()
...
class DinoV2Backbone(Backbone):
    def __init__(self, model_name):
        ...
        local_path = '/projects/extern/CIDAS/cidas_digitalisierung_lehre/cidas_wrkshp_gaze_detection_dl/dir.project/dinov2'
        self.model = torch.hub.load(local_path, model_name, source="local", pretrained=False)
