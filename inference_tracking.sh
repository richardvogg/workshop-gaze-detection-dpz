...
for f in ../.project/dir.project/Richard_Vogg/data/Rocamadour/videos/*.MP4; do
...
python PriMAT-tracking/src/demo.py mot  --load_tracking_model ../.project/dir.project/pretrained_models/tracking_model_50.pth\
                    --conf_thres "$conf"\
                    --det_thres "$det"\
                    --new_overlap_thres 0.8\
                    --sim_thres "$sim"\
                    --input_video ../.project/dir.project/Richard_Vogg/data/Rocamadour/videos/"$vid".MP4\
