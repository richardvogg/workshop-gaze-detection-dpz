...
for vid in GH010561_short GH010563_short; do
#../.project/dir.project/workshop-data/videos/*.MP4; do
#GH010590 GH010592 GH010593 GH010595 GH010596 GH010598 GH010599 GH010600 GH010601 GH010603 GH010604 GH010606 GH010607 GH010609 GH010612 GH010614 GH010615 GH010618 GH010625 GH010627 GH010630 GH010631 GH010632 GH010633 GH010634 GH010636 GH010637 GH010663 GH010664; do 
    ...
    for prop in 1; do
    for buffer in 3; do
#../.project/dir.project/workshop-models/tracking_model_50.pth\
python PriMAT-tracking/src/demo.py mot  \
                    --load_tracking_model PriMAT-tracking/exp/mot/macaques_rocamadour/model_50.pth \
                    --conf_thres "$conf"\
                    --det_thres "$det"\
